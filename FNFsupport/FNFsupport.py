...
class FNFsupport(commands.Cog):
    ...
    async def closerequest(self, ctx: commands.Context, *, reason: str):
        # Assuming ctx.thread.recipient is the user who opened the ticket
        ...
        # Send the close request to the recipient via DM
        ...
        try:
            ...
            # Send a status message to the staff channel
